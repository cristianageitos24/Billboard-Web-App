...
- `.env.local` with `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY`, `SUPABASE_SECRET_KEY`, and optionally `HOUSTON_CITY_ID` (default: `00000000-0000-0000-0000-000000000001`).
...
1. **Env:** Ensure `.env.local` has `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY`, `SUPABASE_SECRET_KEY`, and `NEXT_PUBLIC_GOOGLE_MAPS_API_KEY`. Run `npm install` and `npm run build`.
